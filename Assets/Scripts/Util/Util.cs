...
public class Util
{
    ...
    public static Coroutine WaitUntil(MonoBehaviour monoBehaviour, Action func, Func<bool> predicate)
    {
        return monoBehaviour.StartCoroutine(_WaitUntilCr(func, predicate));
    }
