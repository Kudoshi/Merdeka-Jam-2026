...
public class ButtonAnimationPop : ButtonAnimationBase
{
    ...
    private float _selectedScaleMultiplier = 1.45f;
    ...
    public ButtonAnimationPop(MonoBehaviour mb, ButtonAnimationType animationType, CustomButton button)
        : base(mb, animationType, button)
    {
        ...
        Debug.Log("[ButtonAnimation] Loading: " + button.gameObject.name);
    ...
    private void StartIdleBreathing()
    {
        ...
        Vector3 peakPos = _idleBasePos + new Vector3(0f, 8f, 0f);
        Vector3 peakRot = _idleBaseRot + new Vector3(0f, 0f, 4f);

        _button.transform.localPosition = peakPos;
        _button.transform.localEulerAngles = peakRot;
        ...
        seq.Join(_button.transform
            .DOLocalMove(_idleBasePos, 1.4f)
            .SetEase(Ease.InOutSine));

        seq.Join(_button.transform
            .DOLocalRotate(_idleBaseRot, 1.6f)
            .SetEase(Ease.InOutSine));
